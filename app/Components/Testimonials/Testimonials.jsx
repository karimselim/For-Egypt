            ...
            <li>
              <div className="slide">
                ...
                <p className="mt-[7px] text-center">
                  في جامعة بورسعيد ، نؤمن بأن دور الطالب يمتد إلى ما هو أبعد من
                  حدود الدراسة الأكاديمية. فالانتماء للوطن وخدمة المجتمع يمثلان
                  ركيزة أساسية في بناء الشخصية القيادية والمساهمة الفاعلة في
                  نهضة الأمة، نسعى لصقل شخصيات طلابنا ليكونوا قدوة في الإبداع،
                  القيادة، والعطاء ، مساهمين في تحقيق مستقبل أفضل."
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="slide">
                ...
                <p className="mt-[7px] text-center">
                  ...
                  طالب دورًا كبيرًا في تحقيق أهدافنا المشتركة.
                </p>
              </div>
            </li>
          </div>
