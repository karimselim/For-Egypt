    ...
    <section className="about mx-[7%] my-24 flex justify-between max-md:flex-col gap-12">
      ...
      <aside className="about-right flex-basis-[56%] max-md:flex-basis-full">
        ...
        <p className="text-[#676767] mb-4 text-right text-sm">
         الأسرة هي الكيان الطلابي الوحيد الرسمي على مستوى الجمهورية , الأسرة تمتد جذورها إلى عام 1905 حين بدأت كحركة طلابية لمواجهة الاحتلال البريطاني على يد الزعيم الراحل <b> "مصطفى كامل" </b> 
        وكانت تدعى حينها _بالمدارس العليا_ ،
        مرت الأعوام وواجهت الدولة أزمات و تحديات كثيرة كان للكيانات الطلابية الدور الأبرز في العبور منها ونشر الوعي المجتمعي 
        وترسيخ روح الإنتماء بين أفراد المجتمع ، حيث كانت الأسرة دائمًا داعمًا رئيسيًا لمسيرة الوطن، تجمع الطلاب على هدف واحد وهو خدمة المجتمع والمشاركة الفعالة في تحقيق التنمية. وظلت عبر الأجيال نموذجًا للعمل الوطني والطلابي المخلص.
        ،     
        
        </p>
        <p className="text-[#676767] mb-4 text-right text-sm">
          الأسرة في جامعة بورسعيد تُجسّد رؤية جديدة تساهم في تطوير العملية التعليمية وتلبية احتياجات الطلاب داخل الجامعة و المجتمع بشكل عام.
        ...
        <p className="text-[#676767] mb-4 text-right text-sm">
           تظل أسرة <b> "طلاب من أجل مصر" </b> رمزًا للوحدة و الالتزام والتميز على مستوى 
